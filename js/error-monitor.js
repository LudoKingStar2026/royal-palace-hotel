...
(function () {
    ...
    function createPanel() {
        ...
        document.getElementById("royalHealthClose").onclick =
            function () {
                panel.classList.remove("royal-health-open");
            };

        document.getElementById("royalHealthRetry").onclick =
            retryHealth;

        document.getElementById("royalHealthCopy").onclick =
            copyHealth;

        document.getElementById("royalHealthClear").onclick =
            clearErrors;
    }
    ...
    function moduleStatus(module, loader) {
        ...
        if (Array.isArray(loader.loaded)) {

            loaded = loader.loaded.some(function (item) {
        ...
        if (Array.isArray(loader.failed)) {

            failed = loader.failed.some(function (item) {
        ...
        if (failed) {
            return {
                text: "❌ Failed",
                className: "royal-health-fail"
            };
        }

        return {
            text: "⏳ Waiting",
            className: "royal-health-neutral"
        };
    }
    ...
    function renderPanel() {
        ...
        const overall =
            document.getElementById("royalHealthOverall");

        const modules =
            document.getElementById("royalHealthModules");

        const errors =
            document.getElementById("royalHealthErrors");

        const health = getHealth();

        let overallClass = "royal-health-warn";
        let overallText = "🟡 Application is starting...";
        ...
        if (health) {
            ...
            if (
                ...
                overallClass = "royal-health-good";
                overallText = "🟢 Application is healthy";
                ...
                overallClass = "royal-health-bad";
                overallText = "🔴 Application has errors";

            } else {

                overallClass = "royal-health-warn";
                overallText = "🟡 Application needs attention";
            }
            ...
            overallClass = "royal-health-good";
            overallText = "🟢 Application loaded";
        }
    ...
    async function retryHealth() {
        ...
        if (retryButton) {
            ...
            retryButton.innerText = "⏳ Checking...";
        }
    ...
    async function copyHealth() {
        ...
        let text =
            "Royal Palace Hotel Health Report\n\n";
    ...
    window.renderRoyalHealth =
        renderPanel;

    window.retryRoyalHealth =
        retryHealth;
